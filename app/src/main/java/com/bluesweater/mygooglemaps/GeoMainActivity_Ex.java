 ...
 * <p>
 */
public class GeoMainActivity_Ex extends AppCompatActivity implements OnCompleteListener<Void> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.geo_main_activity);
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(GeoMainActivity_Ex.this,
